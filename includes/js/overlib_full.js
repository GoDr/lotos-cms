...
if (typeof ol_fgcolor == 'undefined')var ol_fgcolor = "lightsteelblue";
if (typeof ol_bgcolor == 'undefined')var ol_bgcolor = "gainsboro";
if (typeof ol_textcolor == 'undefined')var ol_textcolor = "#000000";
if (typeof ol_capcolor == 'undefined')var ol_capcolor = "#000030";
...
function windowWidth() {
    var w;
    if (o3_frame.innerWidth)w = o3_frame.innerWidth; else if (eval('o3_frame.' + docRoot) && eval("typeof o3_frame." + docRoot + ".clientWidth=='number'") && eval('o3_frame.' + docRoot + '.clientWidth'))
...
function createDivContainer(id, frm, zValue) {
    ...
    if (divContainer == null) {
        ...
        if (olIe4 && !olOp)objRef.left = objRef.top = '0px'; else objRef.left = objRef.top = -10000 + (!olNs4 ? 'px' : 0);
    }
    return divContainer;
}
