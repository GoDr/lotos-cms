...
class Jstring{
	...
	function to_utf8($text){
		...
		if(is_string($text)){
			...
			if(!function_exists('cp1259_to_utf8')){ // конвертируем собственнвми средствами
				include_once _LPATH_ROOT . '/includes/libraries/utf8/to_utf8.php';
			}
	...
	function strrpos(){
		...
		include_once _LPATH_ROOT . '/includes/libraries/utf8/strrpos.php';
	...
	function strpos($str, $search, $offset = 0){
		...
		include_once _LPATH_ROOT . '/includes/libraries/utf8/strpos.php';
	...
	public static function strtolower($str){
		...
		include_once _LPATH_ROOT . '/includes/libraries/utf8/strtolower.php';
	...
	function substr($str, $offset, $length = NULL){
		...
		include_once _LPATH_ROOT . '/includes/libraries/utf8/substr.php';
