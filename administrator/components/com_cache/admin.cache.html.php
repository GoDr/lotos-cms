	...
	<form action="index2.php" method="POST" name="adminForm">
		<table cellpadding="3" cellspacing="0" border="0" width="100%" class="adminlist">
			...
			<tr>
				...
				<th class="title" nowrap="nowrap"><?php echo _GROUP; ?></th>
				<th width="5%" align="center" nowrap="nowrap"><?php echo _CACHE_FILE_NUMBER; ?></th>
				<th width="10%" align="center"><?php echo _CACHE_SIZE; ?></th>
			</tr>
			</thead>
			<tfoot>
			<tr>
				<td colspan="6"><?php echo $page->getListFooter(); ?></td>
			</tr>
			</tfoot>
			<tbody>
				<?php
				...
				<tr class="<?php echo "row$rc"; ?>">
					...
					<td>
						<span class="bold"><?php echo $row->group; ?></span>
					</td>
					<td align="center"><?php echo $row->count; ?></td>
					<td align="center"><?php echo CacheItem::convert_size($row->size) ?></td>
				</tr>
					<?php
					$rc = 1 - $rc;
				}
