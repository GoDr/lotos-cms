...
class HTML_config{
		...
		<tr>
			...
			<td valign="top">
				<table class="sub_adminform">
					...
					<tr>
						<td><?php echo mosToolTip(_ACCOUNT_ACTIVATION2, '', '', '', _ACCOUNT_ACTIVATION)?>:</td>
						<td><?php echo $lists['useractivation']; ?></td>
					</tr>
					<tr>
						<td><?php echo mosToolTip(_UNIQUE_EMAIL2, '', '', '', _UNIQUE_EMAIL)?>:</td>
						<td><?php echo $lists['uniquemail']; ?></td>
					</tr>
					<tr>
		...
		<tr>
			<td>
				<table class="sub_adminform">
					...
					<tr>
						<td><?php echo mosToolTip(_DISABLE_SYSTEM_PLUGINS2, '', '', '', _DISABLE_SYSTEM_PLUGINS)?>:</td>
						<td><?php echo $lists['mmb_system_off'];?></td>
					</tr>
					<tr>
						<td><?php echo mosToolTip(_DISABLE_CONTENT_PLUGINS2, '', '', '', _DISABLE_CONTENT_PLUGINS)?>:</td>
						<td><?php echo $lists['mmb_content_off'];?></td>
					</tr>
					<tr>
						<td><?php echo mosToolTip(_DISABLE_MAINBODY_PLUGINS2, '', '', '', _DISABLE_MAINBODY_PLUGINS)?>:</td>
						<td><?php echo $lists['config_mmb_mainbody_off'];?></td>
					</tr>
					<tr>
						<td><?php echo mosToolTip(_COM_CONFIG_CONTENT_USE_SAVE_PLUGIN, '', '', '', _COM_CONFIG_CONTENT_USE_SAVE_PLUGIN)?>:</td>
						<td><?php echo $lists['config_use_content_save_plugins']; ?></td>
					</tr>
					<tr>
						<td><?php echo mosToolTip(_ENABLE_UNPUBLISHED_PLUGINS_HELP, '', '', '', _ENABLE_UNPUBLISHED_PLUGINS)?>:</td>
						<td><?php echo $lists['config_use_unpublished_plugins'];?></td>
					</tr>
				</table>
			</td>
			<td valign="top">
	...
	<td>
		<table class="sub_adminform">
			...
			<tr>
				...
				<td><input class="text_area" type="text" name="config_dir_edit" size="50" value="<?php echo $row->config_dir_edit; ?>"/></td>
			</tr>
			<tr>
			...
			<tr>
				<td><?php echo mosToolTip(_HELP_SERVER2, '', '', '', _HELP_SERVER)?>:</td>
	...
	<table width="100%">
		...
		<tr>
			<td><?php echo mosToolTip(_REGISTRATION_CAPTCHA2, '', '', '', _REGISTRATION_CAPTCHA)?>:</td>
			<td><?php echo $lists['config_captcha_reg'];?></td>
		</tr>
		<tr>
			<td><?php echo mosToolTip(_CONTACTS_CAPTCHA2, '', '', '', _CONTACTS_CAPTCHA)?>:</td>
			<td><?php echo $lists['config_captcha_cont']; ?></td>
		</tr>
	</table>
		<?php
		$tabs->endTab();
