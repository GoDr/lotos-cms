...
require_once(_LPATH_ADMINISTRATOR . '/components/com_jlotossef/admin.jlotossef.class.php');
require_once(_LPATH_ADMINISTRATOR . '/components/com_jlotossef/admin.jlotossef.html.php');
