...
function writableCell($folder){
	...
	echo is_writable(_LPATH_ROOT . '/' . $folder) ? '<b><span style="color:green">' . _WRITEABLE . '</span></b>' : '<b><span style="color:#ff0000">' . _UNWRITEABLE . '</span></b></td>';
	echo '</tr>';
}
...
class HTML_installer{
	...
	<td width="100%" valign="top">
		<div class="cpicons">
			...
			$link = 'index2.php?option=com_installer&amp;element=plugin';
			HTML_installer::quickiconButton($link, 'ext.png', _PLUGINS);
