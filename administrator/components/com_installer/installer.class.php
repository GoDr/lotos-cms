...
class mosInstaller{
	...
	function extractArchive(){
		$base_Dir = mosPathName(_LPATH_ROOT . '/media');
	 ...
	 * Used by Components/Modules/Plugin Installer Installer
	 * @return boolean True on success, False on error
	 */
...
function cleanupInstall($userfile_name, $resultdir){
	...
	if(file_exists($resultdir)){
		deldir($resultdir);
		unlink(mosPathName(_LPATH_ROOT . DS . 'media' . DS . $userfile_name, false));
	}
}
