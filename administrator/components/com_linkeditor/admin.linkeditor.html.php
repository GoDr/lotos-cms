...
class HTML_linkeditor{
	...
	<form action="index2.php" method="post" name="adminForm">
		...
		<table class="adminlist">
			...
			$i = 0;
			foreach($rows as $row){
				$checked = LHtml::idBox($i, $row->id, null);
				...
				<tr class="row<?php echo $k; ?>">
					...
					<td align="center">
						<img src="<?php echo _LPATH_SITE; ?>/includes/<?php echo $img; ?>"/>
					</td>
		...
		<table class="adminform">
			<tr>
				...
				<td colspan="1" rowspan="4">
					<img name="view_imagefiles" src="<?php echo _LPATH_SITE; ?>/includes/<?php echo ($row->admin_menu_img != 'js/ThemeOffice/') ? $row->admin_menu_img : 'js/ThemeOffice/spacer.png'; ?>" width="16"/>
