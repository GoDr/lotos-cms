...
class HTML_trash
{
     ...
     */
    public static function showList($content, $pageNav)
    {
        ?>
        <script>
            /**
    ...
    public static function showDelete($cid, $items, $type)
    {
        $cur_file_icons_path = _LPATH_TPL_ADMI_S . '/' . TEMPLATE . '/images/file_ico';
        ?>
     ...
     */
    public static function showRestore($cid, $items, $type)
    {
