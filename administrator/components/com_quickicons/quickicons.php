...
function quickiButton($row, $newWindow){
	...
	$icon = '<img src="' . _LPATH_SITE . $row->icon . '" alt="' . $title . '" border="0" />';
	if($row->display == 1){
...
<div class="cpicons"><?php
	...
	<div style="display: block; clear: both; text-align:left; padding-top:10px;">
		...
		<a href="index2.php?option=com_quickicons">
			<img border="0" src="<?php echo _LPATH_TPL_ADMI_S . '/' . TEMPLATE;?>/images/file_ico/shortcut.png"/><?php echo _CHANGE_QUICK_BUTTONS?>
		</a>
		<?php } ?>
	</div>
</div>