...
class HTML_QuickIcons{
		...
		<table class="adminlist">
			...
			for($i = 0; $i < $n; $i++){
				...
				<tr class="row<?php echo $k; ?>">
					...
					<td align="center"><img src="<?php echo _LPATH_SITE . $row->icon;?>" alt="" border="0"/></td>
					<td align="left">
	...
	<script>
		...
		function changeIcon(icon) {
			if (document.all) {
				document.all.iconImg.src = '<?php echo _LPATH_SITE; ?>' + icon;
			} else {
				SRAX.get('iconImg').src = '<?php echo _LPATH_SITE; ?>' + icon;
			}
		}
		;
				...
				<td>
					...
					<table width="100%" border="0" cellpadding="2" cellspacing="0" class="adminform">
						...
						<tr>
							...
							<td align="left">
								<input class="inputbox" type="text" name="icon" size="100" maxlength="100" value="<?php echo _LPATH_SITE . $row->icon; ?>" onblur="changeIcon(this.value)"/>
						...
						<tr>
							...
							<td style="padding-top:10px">
								...
								?>
								<img id="iconImg" src="<?php echo _LPATH_SITE . $iconLink; ?>" alt=""/>
							</td>
						</tr>
					</table>
					<?php
    ...
    public static function quickiButton($image){
		...
		$image = str_replace(_LPATH_ROOT, _LPATH_SITE, $image);
