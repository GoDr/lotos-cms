...
LHtml::loadToolTip();
$mainframe->addJS(_LPATH_SITE . '/administrator/components/com_boss/js/function.js');
$mainframe->addCSS(_LPATH_SITE . '/administrator/components/com_boss/css/boss_admin.css');
