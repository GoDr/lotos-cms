...
if(file_exists(_LPATH_ROOT . '/language/' . LCore::getCfg('lang') . '/administrator/com_banners.php')){
	$artbannerslanguage = LCore::getCfg('lang');
} else{
	$artbannerslanguage = 'russian';
}
include_once (_LPATH_ROOT . '/language/' . LCore::getCfg('lang') . '/system.php');
include_once (_LPATH_ROOT . '/language/' . $artbannerslanguage . '/administrator/com_banners.php');
...
if($directory != '' && !is_dir(_LPATH_ROOT . '/images/' . $directory)){
...
<body>
<link rel="stylesheet" href="../../../templates/admin/joostfree/css/template_css.css" type="text/css"/>
