...
function saveTemplateSource(){
	...
	if($client == 'admin'){
		$file = _LPATH_TPL_ADMI . '/' . $template . '/index.php';
	} else{
		$file = _LPATH_TPL_FRONT . '/' . $template . '/index.php';
	}
...
function saveTemplateCSS(){
	...
	if($client == 'admin'){
		$file = _LPATH_TPL_ADMI . '/' . $template . '/css/template_css.css';
	} else{
		$file = _LPATH_TPL_FRONT . '/' . $template . '/css/template_css.css';
	}
