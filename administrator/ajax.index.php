...
// запускаем плагинты событий onAfterAdminAjaxStart
if(LCore::getCfg('mmb_ajax_starts_off') == 0){
	$_PLUGINS->loadBotGroup('admin');
	$_PLUGINS->trigger('onAfterAdminAjaxStart');
}
...
$file_com = _LPATH_ADMINISTRATOR . DS . 'components' . DS . $option . DS . 'admin.' . $commponent . '.ajax.php';
