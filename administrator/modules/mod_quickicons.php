...
if(!defined('_QUICKICON_MODULE')){
	...
	function show_quick_icons($use_ext){
		if($use_ext){
			...
			if(file_exists(_LPATH_TPL_ADMI_S . '/' . TEMPLATE . '/html/quickicons.php')){
				require_once (_LPATH_TPL_ADMI_S . '/' . TEMPLATE . '/html/quickicons.php');
			} else{
				// использование стандартных значков отображения
				require_once (_LPATH_ADMINISTRATOR . '/components/com_quickicons/quickicons.php');
			}
		} else{
			// использование стандартных значков отображения
			require_once (_LPATH_ADMINISTRATOR . '/components/com_quickicons/quickicons.php');
...
// значки быстрого доступа кешируем
