...
define('_LPATH_ROOT',dirname(dirname(dirname(__FILE__))));

require_once _LPATH_ROOT . '/core/defines.php';

require_once ('../includes/auth.php');
include_once (_LPATH_ROOT . '/language/' . LCore::getCfg('lang') . '/system.php');
include_once (_LPATH_ROOT . '/language/' . LCore::getCfg('lang') . '/frontend/com_poll.php');
include_once (_LPATH_ROOT . '/language/' . LCore::getCfg('lang') . '/administrator/com_poll.php');

$database = database::getInstance();
$database->debug(LCore::getCfg('debug'));
