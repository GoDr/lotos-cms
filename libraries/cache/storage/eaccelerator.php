 ...
 * @since        1.3
 */
class CacheStorageEaccelerator extends CacheStorage{
	/**
	 * Constructor
	 * @access protected
	...
	function __construct($options = array()){
		...
		$this->_hash = LCore::getCfg('secret');
	}
	...
	function _getCacheId($id, $group){
		$name = md5(LCore::getCfg('cache_key') . "-" . $this->_application . '-' . $id . '-' . $this->_hash . '-' . $this->_language);
