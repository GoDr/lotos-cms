...
class LibCache
{
    ...
    function __construct($options, $object = null)
    {
        ...
        if (isset($options['cachebase'])) {
            ...
            $this->_options['cachebase'] = _LPATH_ROOT . '/cache';
        }
     ...
     *
     * @return    object    A LibCache object
     * @since    1.3
     */
     ...
     *
     * @access   protected
     * @return object A LibCacheStorage object
     * @since    1.3
     */
...
class CacheStorage
{
     ...
     *
     * @return    object    A LibCacheStorageHandler object
     * @since    1.3
     */
    ...
    function clean($group = 'default', $mode = '')
    {
        ...
        if ($fp = fopen($fname, 'r')) {
            ...
            fclose($fp);
            if ($fp = fopen($fname, 'w')) {
                $pattern = '$mosConfig_cache_key = \'' . LCore::getCfg('cache_key') . '\';';
