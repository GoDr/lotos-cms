...
DEFINE('_AUTOCLEAN_CACHE_DIR', 'Автоматическая очистка каталога кеша');
DEFINE('_AUTOCLEAN_CACHE_DIR2', 'Автоматически очищать каталог кеша удаляя просроченные файлы.');
DEFINE('_AVAILABLE_CHECK_RIGHTS', 'доступно');
DEFINE('_BACK_BUTTON', 'Кнопка Назад (Вернуться)');
DEFINE('_CACHE_DIR2', 'Текущий каталог кеша <b>Доступен для записи</b>');
DEFINE('_CACHE_DIR3', 'Текущий каталог кеша <b>НЕ ДОСТУПЕН ДЛЯ ЗАПИСИ</b> - смените CHMOD каталога на 755 перед включением кеша');
DEFINE('_CACHE_MENU', 'Кеширование меню панели управления');
DEFINE('_CACHE_MENU2', 'Включение кеширования меню панели управления. Работает независимо от стандартного кеша.');
DEFINE('_CACHE_OPTIMIZATION', 'Оптимизация кеширования');
DEFINE('_CACHE_OPTIMIZATION2', 'Автоматически удаляет из файлов кеша лишние символы тем самым уменьшая размер файлов.');
DEFINE('_CACHE_TIME', 'Время жизни кеша');
DEFINE('_CANNOT_CACHE', 'Кеширование не возможно');
DEFINE('_CANNOT_CACHE2', 'Каталог кеша не доступен для записи.');
...
DEFINE('_DB_CACHE', 'Кеш запросов базы данных');
DEFINE('_DB_CACHE_TIME', 'Время жизни кеша запросов базы данных');
...
DEFINE('_DISABLE_CONTENT_PLUGINS', 'Отключить плагины группы content');
DEFINE('_DISABLE_CONTENT_PLUGINS2', 'Если `Да`, то использование плагинов обработки контента будет прекращено. ВНИМАНИЕ, если на сайте используются плагины этой группы, то активация параметра не рекомендуется');
...
DEFINE('_DISABLE_MAINBODY_PLUGINS', 'Отключить плагины группы mainbody');
DEFINE('_DISABLE_MAINBODY_PLUGINS2', 'Если `Да`, то использование плагинов обработки стека компонентов (mainbody) будет прекращено.');
...
DEFINE('_DISABLE_SYSTEM_PLUGINS', 'Отключить плагины группы system');
DEFINE('_DISABLE_SYSTEM_PLUGINS2', 'Если `Да`, то использование системных плагинов будет прекращено. ВНИМАНИЕ, если на сайте используются плагины этой группы, то активация параметра не рекомендуется');
...
DEFINE('_DISABLE_MAINBODY', 'Выводить mosMainbody на Главной странице');
DEFINE('_DISABLE_MAINBODY_INFO', 'Позволяет отключить вывод содержимого (mosMainbody) на Главной странице. Как правило используется при выводе статей на Главной странице при помощи модулей, например GDNewsLotos.');
...
DEFINE('_ENABLE_CACHE', 'Включить кеширование');
DEFINE('_ENABLE_CACHE2', 'Включение кеширования уменьшает запросы к MySQL нагрузку на сервер');
...
DEFINE('_ENABLE_UNPUBLISHED_PLUGINS', 'Использовать неопубликованные плагины');
DEFINE('_ENABLE_UNPUBLISHED_PLUGINS_HELP', 'Некоторые плагины работают даже в неопубликованном состоянии, и очищают текст от спецтегов типа {* *}. Если у вас их нет - рекомендуется выбрать НЕТ.');
...
DEFINE('_HELP_SERVER2', 'Сервер помощи - Если поле пустое, то файлы помощи будут браться из локальной папки http://адрес_вашего_сайта/help/, Для включения сервера On-Line помощи введите http://wiki.joostinadev.ru/ или http://joostinadev.ru/');
...
DEFINE('_SMTP_PORT', 'Порт SMTP');
DEFINE('_SMTP_PORT2', 'Выберите, какой порт будут использовать клиенты для ретрансляции исходящей почты. Обычно это 25 или 587');
...
DEFINE('_USE_OLD_TOOLBAR', 'Использовать старое отображение тулбара');
DEFINE('_USE_OLD_TOOLBAR2', 'При активировании параметра вывод кнопок тулбара будет произведён в режиме таблиц, как было в Joomla.');
...
DEFINE('_COM_CONFIG_CONTENT_USE_SAVE_PLUGIN', 'Разрешить плагины сохранения содержимого');