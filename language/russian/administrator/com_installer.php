...
DEFINE('_NO_FILES_OF_PLUGINS', 'Нет файлов, отмеченных как плагины');
DEFINE('_WRONG_ID', 'Неправильный id объекта');
DEFINE('_BAD_DIR_NAME_EMPTY', 'Поле папки пустое, невозможно удалить файлы');
DEFINE('_INSTALLED_PLUGINS', 'Установленные плагины');
DEFINE('_OTHER_PLUGINS', 'Это не плагины ядра, а сторонние плагины');
DEFINE('_INSTALL_PLUGIN', 'Установка плагина');
...
DEFINE('_COM_INSTALLER_PLUGIN_EXIST', 'Плагин %s уже существует');
