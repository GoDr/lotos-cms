...
defined('_LINDEX') or die('Прямой вызов файла запрещен');
...
DEFINE('_XMAP_MSG_ERROR_CLEAN_CACHE', 'Ошибка. Невозможно очистить кеш карты.');
DEFINE('_XMAP_ERROR_DELETE_DEFAULT', 'Невозможно удалить карту, используемую по умолчанию!');
DEFINE('_XMAP_MSG_CACHE_CLEANED', 'Кеш карты очищен!');
...
DEFINE('_XMAP_CLEAR_CACHE', 'Очистить кеш');
...
DEFINE('_XMAP_CACHE', 'Кеширование');
DEFINE('_XMAP_USE_CACHE', 'Использовать');
DEFINE('_CACHE_TIME', 'Время жизни кеша');
