 ...
 */
DEFINE('_DATE_FORMAT_LC', LCore::getCfg('form_date')); //Используйте формат PHP-функции strftime
DEFINE('_DATE_FORMAT_LC2', LCore::getCfg('form_date_full')); // Полный формат времени
...
DEFINE('_NOT_EXIST', '<div class="error">Извините, страница не найдена.<br />Пожалуйста, вернитесь на главную страницу сайта.</div><div class="clear"></div>');
...
DEFINE('_PN_OF', 'из');
DEFINE('_PN_START', '<img src="/templates/front/default/images/new_go_first.png" alt="Первая" />');
DEFINE('_PN_PREVIOUS', '<img src="/templates/front/default/images/new_go_previous.png" alt="Предыдущая" />');
DEFINE('_PN_NEXT', '<img src="/templates/front/default/images/new_go_next.png" alt="Следующая" />');
DEFINE('_PN_END', '<img src="/templates/front/default/images/new_go_last.png" alt="Последняя" />');
...
DEFINE('_SEL_FIELD', '- Выберите поле -');
...
DEFINE('_DONT_USE_FILE', '- Не использовать файл -');
...
DEFINE('_ERROR_DELETING_CACHE', 'Ошибка удаления кеша');
DEFINE('_ERROR_READING_CACHE_DIR', 'Ошибка чтения директории кеша');
DEFINE('_ERROR_READING_CACHE_FILE', 'Ошибка чтения файла кеша');
DEFINE('_ERROR_WRITING_CACHE_FILE', 'Ошибка записи файла кеша');
DEFINE('_SCRIPT_MEMORY_USING', 'Использовано памяти');
DEFINE('_SCRIPT_TIME_USING', 'Время генерации страницы: ');
...
DEFINE('_CACHE_SYSTEM', 'Тип кеширующей системы');
 ...
 */
DEFINE('_CACHE_DIR_IS_NOT_WRITEABLE', 'Пожалуйста, сделайте каталог кеша доступным для записи');
DEFINE('_CACHE_DIR_IS_NOT_WRITEABLE2', 'Каталог кеша не доступен для записи');
DEFINE('_CLEANING_ADMIN_MENU_CACHE', 'Ошибка очистки кеша меню панели управления');
DEFINE('_MENU_CACHE_CLEANED', 'Кеш меню панели управления очищен');
DEFINE('_NO_MENU_ADMIN_CACHE', 'Кеш меню панели управления не обнаружен. Проверьте права доступа на каталог кеша.');
...
DEFINE('_REGWARN_NAME', 'Пожалуйста, введите ваше имя.');
DEFINE('_REGWARN_BODY', 'Пожалуйста, введите сообщение.');
...
DEFINE('_MAIL_MSG', 'Здравствуйте $adminName,\n\nПользователь $author предлагает новый материал в раздел $type с названием $title' .
	' для сайта _LPATH_SITE.\n\n\n' .
	'Пожалуйста, зайдите в панель администратора по адресу _LPATH_SITE/administrator для просмотра и добавления его в $type.\n\n' .
