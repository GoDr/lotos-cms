...
DEFINE('_NEWPASS_MSG', 'Учетная запись пользователя $checkusername соответствует адресу e-mail.\n' .
	' Пользователь сайта _LPATH_SITE сделал запрос на получение нового пароля.\n\n' .
...
DEFINE('_USEND_MSG_NOPASS', 'Здравствуйте $name,\n\nВы успешно зарегистрированы на сайте '._LPATH_SITE.'.\n' .
	'Вы можете зайти на сайт '._LPATH_SITE.', используя данные, которые Вы указали при регистрации.\n\n' .
