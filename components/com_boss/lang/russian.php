...
DEFINE("BOSS_CONTENTS_PER_PAGE_FRONT", "Контента на страницу на Главной");
DEFINE("BOSS_CONTENTS_PER_PAGE_FRONT_LONG", "Контента на страницу на Главной по умолчанию для всех категорий каталога");
DEFINE("BOSS_CONTENTS_PER_PAGE", "Контента на страницу");
DEFINE("BOSS_CONTENTS_PER_PAGE_LONG", "Контента на страницу по умолчанию для всех категорий каталога");
...
DEFINE("BOSS_FIELD_ACCESS", "Доступ:");
DEFINE("BOSS_FIELD_ACCESS_TIP", "Укажите группу, которой будет доступно указанное поле");
DEFINE('BOSS_FIELD_GUEST', 'Гостевой');
...
DEFINE("BOSS_VIEWS", "<img src='/templates/components/com_boss/default/images/eye.png' alt='Просмотров' />&nbsp;%s");
...
DEFINE("BOSS_IMAGE_DISPLAY_NONE", "Без эффектов");
...
DEFINE("BOSS_IMAGE_PLAGINS_CAT", "Применять ли плагины Lotos CMS при отображении категорий?");
DEFINE("BOSS_IMAGE_PLAGINS_CNT", "Применять ли плагины Lotos CMS при отображении контента?");
DEFINE("BOSS_IMAGE_PLAGINS_DESC", "В тег IMG будет добавлен пользовательский параметр data-plugin-core. ДА - data-plugin-core='1', НЕТ - data-plugin-core='0'");
...
DEFINE("BOSS_CONTACT_BY_PMS_LONG", "Позволяет связаться с автором через систему приватных сообщений, необходимо установить  компонент приватных сообщений, например JIM, Missus и проассоциировать contentsmanager плагин");
...
DEFINE('BOSS_READ_MORE', '<img src="/templates/components/com_boss/default/images/forward_2.png" alt="Комментарии" />&nbsp;Подробнее');
...
DEFINE('BOSS_NUM_REVIEWS', '<img src="/templates/components/com_boss/default/images/comment.png" alt="Комментарии" />&nbsp;%s');
...
DEFINE('BOSS_CONTENT_PLUGIN', 'Разрешить использование плагинов');
...
DEFINE('BOSS_CONTENT_PLUGIN_LONG', "&nbsp;");
...
DEFINE("BOSS_SUBCAT", "Показывать содержимое подкатегорий");
DEFINE("BOSS_SUBCAT_FULL", "Если выбрано ДА, то будут отображаться материалы подкатегорий");
...
DEFINE("BOSS_TAGS", "<img src='/templates/components/com_boss/default/images/tag_red.png' alt=\"Теги\" />&nbsp;");
...
DEFINE("BOSS_TPL_FIELDS_DESC", "Поставьте галку cлоя привязки поля к позиции шаблона, если к одной позиции шаблона привязано несколько полей, то в поле рядом с галками этой позиции введите числа для сортировки.");
