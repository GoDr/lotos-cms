...
class viewSelector{
	...
	public function displaySettingsForm($directory){
		...
		foreach($fields as $field){
			$fieldList[] = LHtml::makeOption($field->name, $field->title);
		}
		?>
	<form action="index2.php" name="adminForm" method="post">
		<table cellpadding="4" cellspacing="0" border="0" width="100%" class="adminlist">
			...
			<tr>
				...
				<td><?php echo LHtml::selectList($fieldList, 'field', 'class="inputbox" size="1"', 'value', 'text', @$options['field']);?></td>
	...
	public function saveOptions($directory){
		...
		mosRedirect(_LPATH_SITE . '/administrator/index2.php?option=com_boss&act=plugins&directory=' . $directory, BOSS_PLUG_SAVE_OK);
	}
