...
if (isset($_SERVER['HTTP_REFERER'])) {
    ...
    // корень файлов
    define('_LPATH_ROOT', $_SERVER['DOCUMENT_ROOT']);
    ...
    if (file_exists($path . '/' . LCore::getCfg('lang') . '.php')) {
        require_once($path . '/' . LCore::getCfg('lang') . '.php');
    } else {
    ...
    if ($value == 0 OR $content_id == 0 OR ($ip == 0 AND $user_id == 0)) {
        ...
        require_once(_LPATH_ROOT . '/includes/libraries/text/text.php');
