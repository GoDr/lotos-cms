...
class GDRating
{
    ...
    public function displayVoteForm($content, $directory, $conf)
    {
        ...
        if ($conf->allow_ratings) {
            ...
            $path = _LPATH_ROOT . '/components/com_boss/plugins/ratings/GDRating/lang';
            ...
            if (!defined('_GDRATING_CSS')) {
                ...
                $mainframe->addCSS(_LPATH_SITE . '/components/com_boss/plugins/ratings/GDRating/style.css');
            }
            // выводим рейтинг
        ...
        if (!$this->result_only) {
            ...
            if ($my->id == 0 AND $this->conf->allow_unregisered_comment == 0) {
                    ...
                    if (empty($voted)) {
                        $result
						 ...
						 onclick="gd_rating_plugin('
                            ...
                            . $this->directory . ','
                            . $my->id . ', \''
                            . _LPATH_SITE . '/components/com_boss/plugins/ratings/GDRating/db.php\')"
                ...
                if (!defined('_GDRATING_JS')) {
                    ...
                    $mainframe->addJS(_LPATH_SITE . '/components/com_boss/plugins/ratings/GDRating/script.js');
                }
                return $result;
            }
        }
