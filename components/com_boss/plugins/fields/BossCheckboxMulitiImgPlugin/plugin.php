 ...
 * @Date      21.07.2013
 * @see       http://wiki.lotos-cms.ru/index.php/BossCheckboxMulitiImgPlugin
 */
...
class BossCheckboxMulitiImgPlugin
{
    ...
    function getDetailsDisplay($directory, $content, $field, $field_values, $conf)
    {
        ...
        for ($i = 0, $nb = count($field_values); $i < $nb; $i++) {
            ...
            if (strpos($value, $fieldvalue) !== false) {
                $dataArray[] = "<img src='" . _LPATH_SITE . "/images/boss/$directory/fields/" . $fieldtitle . "' alt='$fieldtitle' />";
            }
        }
        ...
        for ($i = 0; $i < $field->rows; $i++) {
            ...
            for ($j = 0; $j < $field->cols; $j++) {
                ...
                if ($field->type == 'multicheckbox') {
                    ...
                    $fieldtitle = "<img src=\"" . _LPATH_SITE . "/images/boss/" . $directory . "/fields/" . $fieldtitle . "\" alt='$fieldtitle' />";
                }
    ...
    function getEditFieldOptions($row, $directory, $fieldimages, $fieldvalues)
    {
        ...
        $mainframe->addJS(_LPATH_SITE . '/components/com_boss/plugins/fields/BossCheckboxMulitiImgPlugin/js/script.js');
        ...
        <script>
            ...
            function showimage(preview, obj) {
                if (getSelectedValue(obj) == "null" || !getSelectedValue(obj))
                    var imgPath = "' . _LPATH_TPL_COM_S . '/com_boss/default/images/nopic.gif";
                else
                    imgPath = "' . _LPATH_SITE . '/images/boss/' . $directory . '/fields/" + getSelectedValue(obj);
            ...
            oImage.setAttribute("src", "' . _LPATH_SITE . '/images/boss/' . $directory . '/fields/' . $row->link_image . '");
            ...
            foreach ($fieldvalues as $fieldvalue) {
                ...
                $return
                    .= '
                                ...
                                <img src="' . _LPATH_SITE . '/images/boss/' . $directory . '/fields/' . stripslashes($fieldvalue->fieldtitle) . '"
