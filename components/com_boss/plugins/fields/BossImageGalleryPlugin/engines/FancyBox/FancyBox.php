...
function galleryAddInHead($path){
    ...
    $mainframe->addCSS($path . '/css/fancybox.custom.css', true);
...
<div class="thumbsContainer">
	...
	if(file_exists(_LPATH_ROOT . $pic)){
		...
		<a class="thumb_link" href="<?php echo $full; ?>" title="<?php echo $title; ?>" rel="thumb_set_<?php echo $content->id; ?>">
			<img src="<?php echo _LPATH_SITE . $pic; ?>" alt="<?php echo htmlspecialchars(stripslashes(cutLongWord($content->name)), ENT_QUOTES); ?>"/>
		</a>
		<?php
	} else{
