...
class BossDirectoryMultiHrefPlugin{
	...
	function loadCategory(){
		...
		require_once(_LPATH_ROOT . DS . 'administrator' . DS . 'components' . DS . 'com_boss' . DS . 'admin.boss.html.php');
	...
	function loadHref(){
		...
		echo '<a href="' . _LPATH_SITE . '/index.php?option=com_boss&task=show_content&contentid=' . $sel_cont . '&catid=' . $sel_cat . '&directory=' . $sel_dir . '">' . $row->name . '</a>';
	}
}
