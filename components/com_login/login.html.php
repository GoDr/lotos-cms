...
class loginHTML{
	...
	public static function loginpage($params, $image){
		...
		?>
	<form action="<?php echo LSef::getUrlToSef('index.php?option=login'); ?>" method="post" name="login" id="login">
					...
					<table>
						...
						<tr>
							<td align="center" colspan="2">
								...
								<br/>
								<a href="<?php echo LSef::getUrlToSef('index.php?option=com_users&amp;task=lostPassword'); ?>">
								...
								if($params->get('registration')){
									...
									<a href="<?php echo LSef::getUrlToSef('index.php?option=com_users&amp;task=register'); ?>">
		...
		LHtml::BackButton($params);
		?>

		<input type="hidden" name="op2" value="login"/>
		<input type="hidden" name="return" value="<?php echo LSef::getUrlToSef($return); ?>"/>
	...
	public static function logoutpage($params, $image){
		...
		?>
	<form action="<?php echo LSef::getUrlToSef('index.php?option=logout'); ?>" method="post" name="login" id="login">
		<table width="100%" border="0" align="center" cellpadding="4" cellspacing="0" class="contentpane<?php echo
		$params->get('pageclass_sfx'); ?>">
			<tr>
				<td valign="top">
