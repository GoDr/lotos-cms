...
if(LCore::getCfg('frontend_login') != null && (LCore::getCfg('frontend_login') === 0 || LCore::getCfg('frontend_login') === '0' || LCore::getCfg('no_session_front') != 0)){
...
$params->def('login', _LPATH_SITE);
$params->def('logout', _LPATH_SITE);
...
if($params->get('image_login') != -1){
	$image = _LPATH_SITE . '/images/stories/' . $params->get('image_login');
	$image_login = '<img src="' . $image . '" align="' . $params->get('image_login_align') . '" hspace="10" alt="" />';
}
if($params->get('image_logout') != -1){
	$image = _LPATH_SITE . '/images/stories/' . $params->get('image_logout');
