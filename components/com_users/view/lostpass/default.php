...
<div class="lostpass_page">
	<form action="<?php echo LSef::getUrlToSef('index.php')?>" method="post" name="mosForm" id="mosForm">
		...
		<div class="captcha">
			<img id="captchaimg" alt="<?php echo _PRESS_HERE_TO_RELOAD_CAPTCHA?>" onclick="document.mosForm.captchaimg.src='<?php echo _LPATH_SITE; ?>/includes/libraries/kcaptcha/index.php?session=<?php echo MainFrame::sessionCookieName() ?>&' + new String(Math.random())"
