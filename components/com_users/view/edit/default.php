...
LHtml::loadJqueryPlugins('jquery.validate', false, false, 'js');
...
<div class="edit_profile_page">
	...
	<form action="<?php echo LSef::getUrlToSef('index.php');  ?>" method="post" name="mosUserForm" id="mosUserForm">
		...
		<table width="100%">
			<tr>
				...
				<td><?php echo LHtml::genderSelectList('gender', 'class="inputbox"', $user_extra->gender);?> </td>
			</tr>
			<tr>
	...
	$form_params->ajax_handler = _LPATH_SITE . '/ajax.index.php?option=com_users';
	if(!$user->avatar){
