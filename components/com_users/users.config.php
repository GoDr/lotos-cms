	...
	<form action="index2.php" method="post" name="adminForm">
		...
		<table class="paramlist">
			...
			<tr>
				...
				<td><?php echo LHtml::yesnoRadioList('template', '', $this->template ? 1 : 0); ?></td>
			</tr>
			<tr>
				<th class="key"><?php echo _C_USERS_REG_DEFAULT_GROOPS?></th>
				<td><?php echo LHtml::selectList($gtree, 'gid', 'size="1"', 'value', 'text', $this->gid); ?></td>
			</tr>
			<tr>
				<th class="key"><?php echo _C_USERS_REG_PROFILE_ACTIVATE?></th>
				<td><?php echo LHtml::yesnoRadioList('admin_activation', '', $this->admin_activation ? 1 : 0); ?></td>
			</tr>
		</table>
	...
	<form action="index2.php" method="post" name="adminForm">
		...
		<table class="paramlist">
			...
			<tr>
				...
				<td><?php echo LHtml::yesnoRadioList('template_edit', '', $this->template_edit ? 1 : 0); ?></td>
			</tr>

			<tr>
				<th class="key"><?php echo _TEMPLATE_DIR?></th>
				<td><?php echo LHtml::yesnoRadioList('template_dir', '', $this->template_dir ? 1 : 0, _TEMPLATE_DIR_DEF, _TEMPLATE_DIR_SYSTEM); ?></td>
			</tr>
