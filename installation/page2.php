 ...
 * @description Третья страница установки
 */
...
function getContent()
{
    ...
    $DBPrefix = (isset($_POST['DBPrefix'])) ? trim($_POST['DBPrefix']) : 'lts_';
    ...
    <form action="index.php?page=3" method="post" name="form" id="form">
        <table class="content">
            ...
            <tr>
                ...
                <td>Все существующие таблицы от предыдущих установок Lotos CMS будут удалены.
                </td>
            </tr>
            <tr>
                ...
                <td>Все существующие резервные копии таблиц от предыдущих установок Lotos CMS будут заменены.</td>
            </tr>
            <tr>
                ...
                <td><span style="color: #ff0000">Не выключайте это, если Вы ещё не знакомы с Lotos CMS! Вы всегда можете легко удалить примеры!</span></td>
            </tr>
        </table>
    </form>
    <script>
