...
if(!defined('_JOS_RSSFEED_MODULE')){
	...
	function output_rssfeed($link, $img_default, $img_file, $img_alt, $img_name){
		$img = LAdminMenu::ImageCheck($img_default, '/images/system/', $img_file, '/images/system/', $img_alt, $img_name);
		?><a class="<?php echo $img_name;?>" href="<?php echo LSef::getUrlToSef($link); ?>" title="<?php echo $img_alt;?>"><?php echo $img ?></a><?php
	}
}
...
$t_path = _LPATH_TPL_FRONT_S . '/' . TEMPLATE . '/images/';
$d_path = _LPATH_SITE . '/images/system/';
