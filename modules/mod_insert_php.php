 ...
 * @see         http://wiki.lotos-cms.ru/index.php/InsertPHP
 */
...
if (!function_exists('modInsertPhp')) {
    function modInsertPhp($params, $module)
    {
        ...
        if (!is_null($_error_code) and stristr($_error_code['file'], 'mod_insert_php.php') !==false and $params->get('error', 0)) {
            $_lang = LLang::getLang('mod.insert_php');
