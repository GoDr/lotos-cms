...
if ($serverinfo) {
    ...
    echo "<strong>" . _TIME_STAT . ": </strong> " . date("H:i", time() + (LCore::getCfg('offset') * 60 * 60)) . "<br />\n";
    $c = LCore::getCfg('caching') ? _YES : _NO;
    echo '<strong>' . _CACHE . ':</strong> ' . $c . '<br />';
    $z = LCore::getCfg('gzip') ? _YES : _NO;
