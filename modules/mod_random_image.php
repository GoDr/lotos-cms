...
if(strpos($folder, _LPATH_SITE) === 0){
	$folder = str_replace(_LPATH_SITE, '', $folder);
}
// if folder includes absolute path, remove
if(strpos($folder, _LPATH_ROOT) === 0){
	$folder = str_replace(_LPATH_ROOT, '', $folder);
}
...
$abspath_folder = _LPATH_ROOT . $folder;
...
<?php } ?>
			...
			case '1':
				...
				<?php
					...
					echo LHtml::loadJqueryPlugins('jquery.simplegallery', true);
					include (_LPATH_ROOT . '/modules/mod_random_image/slide_show.php');
					?>
