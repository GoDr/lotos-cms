...
$template_path = _LPATH_ROOT . '/templates';
...
<form action="index.php" name="templateform" method="post">
	<?php echo LHtml::selectList($darray, 'jos_change_template', "id=\"mod_templatechooser_jos_change_template\" class=\"button\" onchange=\"$onchange\"", 'value', 'text', $cur_template); ?>
