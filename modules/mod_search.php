...
switch($text_pos){
	case 'iside':
	default:
		$output = '<input name="searchword" id="mod_search_searchword" maxlength="100" class="inputbox' . $moduleclass_sfx . '" type="text" size="' . $width . '" value="' . $text . '"  onblur="if(this.value==\'\') this.value=\'' . $text . '\';" onfocus="if(this.value==\'' . $text . '\') this.value=\'\';" />';
		break;
	...
	case 'top':
		$output = '<strong>' . $text . '</strong><br /><input name="searchword" id="mod_search_searchword" maxlength="100" class="inputbox' . $moduleclass_sfx . '" type="text" size="' . $width . '" value=""  />';
		break;
