...
<div class="mod_ml_login">
	...
	<div id="box1">
		<form action="<?php echo LSef::getUrlToSef('index.php'); ?>" method="post" name="login">
			<div class="login_form">
				...
				<p>
					<a href="<?php echo LSef::getUrlToSef('index.php?option=com_users&amp;task=register');?>"><?php echo $params->get('ml_reg_text', _CREATE_ACCOUNT)?></a>&nbsp;&nbsp;
					<a href="<?php echo LSef::getUrlToSef('index.php?option=com_users&amp;task=lostPassword');?>"><?php echo $params->get('ml_rem_pass_text', _LOST_PASSWORDWORD);?></a>
				</p>
			</div>
			<input type="hidden" name="option" value="login"/>
			<input type="hidden" name="op2" value="login"/>
			<input type="hidden" name="lang" value="<?php echo $mainframe->getCfg('lang'); ?>"/>
			<input type="hidden" name="return" value="<?php echo LSef::getUrlToSef($params->get('login', $params->_returnUrl)); ?>"/>
			<input type="hidden" name="message" value="<?php echo $params->get('login_message', ''); ?>"/>
			<input type="hidden" name="force_session" value="1"/>
			<input type="hidden" name="<?php echo $validate; ?>" value="1"/>
		</form>
        <div class="closewin">закрыть</div>
	</div>
	<script>
