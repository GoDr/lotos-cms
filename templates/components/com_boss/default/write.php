<div class="boss_content">
    <article>
        ...
        <div class="boss-rules">
            <a href="<?php echo LSef::getUrlToSef("index.php?option=com_boss&task=show_rules&directory=$this->directory"); ?>" target=_blank>
        ...
        <fieldset id="boss_fieldset" width="90%" align="center">
            ...
            if ($this->isAccountCreation()) {
                ...
                <h2 class="contentheading">
                    <?php echo BOSS_FORM_ALERT; ?>
                </h2>
                <?php $this->displayAccountCreationFields(); ?>
                <?php } ?>
            <br/>
            <h2 class="contentheading">
                <?php echo BOSS_FORM_INFORMATION; ?>
            </h2>
            <!--fields -->
            ...
            <?php if ($this->isContentCaptchaActivated() && $my->id == 0) {
                ...
                <?php $this->displayCaptchaInput(); ?><br/>
                <?php } ?>
            <!-- buttons -->
