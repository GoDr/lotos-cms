...
<head>
	...
	<title><?php echo LCore::getCfg('sitename'); ?> - <?php echo _SITE_OFFLINE?></title>
	<link rel="stylesheet" href="<?php echo _LPATH_TPL_FRONT_S . '/' . $cur_template; ?>/css/template_css.css" type="text/css"/>
</head>
	...
	if(LCore::getCfg('offline') == 1){
		...
		<tr>
			<td>
				<h2>
					<?php
					echo LCore::getCfg('sitename');
					echo ' - ';
					echo LCore::getCfg('offline_message');
					?>
				</h2>
			</td>
		</tr>
		...
		<tr>
			<td>
				<h2>
					<?php echo LCore::getCfg('error_message'); ?>
				</h2>
